...
Do not use this checklist as approval evidence until each item is verified and dated.
...
- [ ] Logo approved.
- [ ] Favicon approved.
- [ ] Social image approved.
- [ ] Photography approved.
- [ ] Fonts licensed and self-hosted if used.
...
- [ ] HTTPS active.
- [ ] HSTS verified.
- [ ] Production headers inspected.
- [ ] CSP verified on live domain.
